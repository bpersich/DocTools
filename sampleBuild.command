# Variables. Define these for your system/content
  markeditclipath="<Path to your marked-it-cli directory>" # For example; "/Users/bpersich/node_modules/marked-it-cli"
  sourcepath="<Path to your markdown source file>" # For example: "/Users/bpersich/MD-transforms/sap-hana"
  outputpath="<Path to where you want to write your output>" # For example: "/Users/bpersich/MD-transforms/sap-hana-output"
  outputlogfilepath="<Path to where you want to write your output log file>" # "/Users/bpersich/MD-transforms/"
